...
interface OAuthServiceInterface {
     ...
     * @return mixed An instance of {@link \Genetsis\DruID\Core\OAuth\Beans\ClientToken} with data retrieved or FALSE.
     ...
     * @return mixed An instance of {@link \Genetsis\DruID\Core\OAuth\Beans\AccessToken} if its connected or NULL if not.
     * @throws \Exception If there is an error.
     */
     ...
     *
     * @param string $name The token we want to remove. Must be one value defined in {@link \Genetsis\DruID\Core\OAuth\Collections\TokenTypes}
     * @return void
     */
     ...
     *
     * @param string $name The token we want to check. Are defined in {@link \Genetsis\DruID\Core\OAuth\Collections\TokenTypes}
     ...
     *
     * @param string $name The token we want to recover. Are defined in {@link \Genetsis\DruID\Core\OAuth\Collections\TokenTypes}
