...
class LoginStatusTest extends TestCase
{
    ...
    public function testSetterAndGetterCkusid()
    {
        $this->specify('Checks setter and getter for "ckusid" property.', function() {
            $this->assertInstanceOf('\Genetsis\DruID\Core\User\Beans\LoginStatus', $this->login_status->setCkusid('ckusid'));
    ...
    public function testSetterAndGetterOid()
    {
        $this->specify('Checks setter and getter for "oid" property.', function() {
            $this->assertInstanceOf('\Genetsis\DruID\Core\User\Beans\LoginStatus', $this->login_status->setOid('oid'));
    ...
    public function testSetterAndGetterConnectState()
    {
        $this->specify('Checks setter and getter for "connect state" property.', function() {
            $this->assertInstanceOf('\Genetsis\DruID\Core\User\Beans\LoginStatus', $this->login_status->setConnectState(LoginStatusTypesCollection::CONNECTED));
